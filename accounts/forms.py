...
class BookForm(forms.ModelForm):
    class Meta:
        ...
        fields = [
            ...
            'published_year', 'condition', 'genre', 'language',
        ]
        widgets = {
            'title': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Kitabın adı'}),
            'author_name': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Müəllifin adı'}),
            'description': forms.Textarea(attrs={'class': 'form-control', 'rows': 4, 'placeholder': 'Ətraflı məlumat...'}),
            'price': forms.NumberInput(attrs={'class': 'form-control', 'step': '0.01', 'min': '0'}),
            'published_year': forms.NumberInput(attrs={'class': 'form-control', 'placeholder': 'Məsələn: 2020', 'min': '1', 'step': '1'}),
...
class RegisterForm(forms.ModelForm):
    ...
    class Meta:
        # qlobal User əvəzinə birbaşa funksiyanı çağırırıq
